...
namespace TimeTwoFix.Application.UserServices.Services
{
    public class UserServices : IUserServices
    {
        ...
        public UserServices(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, SignInManager<ApplicationUser> signInManager, IMapper mapper)
        {
